...
Words <u>AND</u> numbers in your file:<br> <textarea readonly class='resizedTextbox inlined' id='words_and_numbers1'><?php echo $resultingNiceArray[0]; ?></textarea> <button class='simple_copy inlined btn btn-secondary' id='copy_button1'>Copy</button><br />
		...
		% of repetitions:<br> <textarea readonly  class='resizedTextbox inlined' id='words_and_numbers5'><?php echo $resultingNiceArray[4]; ?></textarea> <button class='simple_copy inlined btn btn-secondary' id='copy_button5'>Copy</button><br/><br/>Enter your full rate: <textarea class='resizedTextbox inlined moved_down' id='your_rate' maxlength='5'>0.00</textarea><br/>Enter your rate <u>for repetitions</u>: <textarea class='resizedTextbox inlined moved_down' id='rep_rate' maxlength='5'>0.00</textarea><br /><br /><div class='returned_results'><button class="btn btn-secondary" id='copy_button6'>Get and copy your quote!</button><textarea readonly  class='resizedTextboxQuote' id='quote'>0.00</textarea><div class='support_text'><div class="back_button btn btn-info" onclick="location.href='https://t9ncounter.com'">Back to counter</div><br><br>Would you like to <u>support</u> t9ncounter.com?<br>Drop me a line to <a href="mailto:info@engrutra.com">Vadim Kadyrov</a>!</div></div>
